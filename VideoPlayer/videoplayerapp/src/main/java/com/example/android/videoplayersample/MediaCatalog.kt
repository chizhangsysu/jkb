...
//            setDescription("MP4 loaded locally")
//            setMediaId("1")
//            setMediaUri(Uri.parse("file:///storage/self/primary/Download/jiankangbao.mp4"))
//            setTitle("Jiankangbao")
...
//        },
        with(MediaDescriptionCompat.Builder()) {
            setDescription("MP4 loaded locally")
            setMediaId("2")
            setMediaUri(Uri.parse("file:///storage/emulated/0/DCIM/jiankangbao.mp4"))
            setTitle("Jiankangbao")
            setSubtitle("Streaming ==== video")
            build()
        }
